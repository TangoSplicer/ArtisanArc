...
void main() {
  ...
  group('AppTheme dark mode', () {
    test('uses readable body and heading text on dark surfaces', () {
      ...
      expect(_contrastRatio(bodyText, theme.scaffoldBackgroundColor),
          greaterThanOrEqualTo(4.5));
      expect(_contrastRatio(headingText, theme.colorScheme.surface),
          greaterThanOrEqualTo(4.5));
    });
    ...
    test('keeps fields, cards, and navigation labels readable', () {
      ...
      expect(_contrastRatio(theme.colorScheme.onSurface, cardColor),
          greaterThanOrEqualTo(4.5));
      expect(_contrastRatio(appBarText, theme.appBarTheme.backgroundColor!),
          greaterThanOrEqualTo(4.5));
    });
  });
}
