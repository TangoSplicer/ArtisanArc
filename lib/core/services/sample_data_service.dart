  ...
  static Future<void> loadStarterData({bool replaceExisting = false}) async {
    ...
    final inventoryItems = <InventoryItem>[
      InventoryItem(
          ...
          category: 'Crochet Amigurumi & Plush',
          quantity: 9,
          price: 5.00,
      ...
      InventoryItem(
          ...
          category: 'Yarn — Cotton & Plant Fibre',
          quantity: 10,
          price: 3.75,
      ...
      InventoryItem(
          ...
          category: 'Yarn — Wool & Animal Fibre',
          quantity: 6,
          price: 5.50,
          ...
          itemType: 'material',
          reorderPoint: 3,
          yarnBrand: 'Hearth Wool',
          yarnRange: 'Chunky',
          yarnColour: 'Oatmeal',
          yarnWeight: 'Bulky / Chunky',
          yarnFibre: 'Wool',
          yarnWeightGrams: 100,
          yarnLengthMetres: 100,
          recommendedHookSize: '6.00 mm'),
      InventoryItem(
          id: 'sample-hook-4mm',
